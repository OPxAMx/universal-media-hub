  ...
  return (
    <Layout>
      <div className="space-y-12">
        ...
        {/* STATS TICKER — infinite horizontal scroll */}
        ...
        {/* GLASSMORPHIC CAROUSELS per type */}
        {stats.map(s => (
        ...
        <div className="space-y-6">
          ...
          {filtered.length > 0 ? (
            <section>
              <h2 className="font-heading text-xl font-bold text-foreground mb-4">Tous les contenus</h2>
